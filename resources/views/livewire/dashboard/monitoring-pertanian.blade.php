<div x-data="{ item: @entangle('itemMonitoring') }">
    @foreach ($subsektor as $sb)
        <button wire:click="updateItem('{{ $sb->nama }}')"
            class="inline-flex items-center gap-2d px-2 py-2 text-xs font-medium  transition rounded-lg {{ $sb->nama === $itemMonitoring ? 'bg-brand-500 text-white' : 'border border-primary text-brand-500 hover:bg-brand-600 hover:text-white' }} shadow-theme-xs  mb-3">
            {{ $sb->nama }}
        </button>
    @endforeach
      ...
      <div class="rounded-2xl border border-gray-200 bg-gray-200 dark:border-gray-800 dark:bg-white/[0.03]">
          <div class="shadow-default rounded-2xl bg-white px-5 pb-11 pt-5 dark:bg-gray-900 sm:px-6 sm:pt-6">
              <div class="flex justify-between">
                  <div>
                      <h3 class="text-center text-lg font-semibold text-gray-800 dark:text-white/90">
                          Survei Laporan Tahunan Peternakan Unggas (LTU)
                      </h3>
                  </div>
              ...
              <div class="relative max-h-[195px]">
                  <div id="chartProgress" class="h-full"></div>
              </div>
    ...
    <div
        ...
        <div class="max-w-full overflow-x-auto custom-scrollbar">
            <div class="-ml-5 min-w-[600px] pl-2 xl:min-w-full">
                <div id="chartProgresKSA" class="-ml-5 h-full min-w-[600px] pl-2 xl:min-w-full"></div>
            </div>
        </div>
    </div>
    <script type="module" src="/js/halfDonutChart-progress.js"></script>
    <script type="module" src="/js/barChart-progres.js"></script>
</div>
