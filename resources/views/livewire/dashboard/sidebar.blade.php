<aside x-data="{ sidebarHover: false }"
    ...
    <div :class="sidebarToggle || sidebarHover ? 'justify-between' : 'justify-center'"
        ...
        <a href="{{ route('home') }}">
            ...
            <span class="flex items-center lg:mt-0 mt-20"
                :class="sidebarToggle || sidebarHover ? 'hidden' : 'lg:block'">
                ...
                <ul class="mb-6 flex flex-col gap-4">
                    ...
                    <div>
                        ...
                        <ul class="mb-6 flex flex-col gap-4">
                            ...
                            <ul class="mb-6 flex flex-col gap-4">
                                <x-dashboard.sidebar-item itemSelected="Administrasi" isSubItem="true"
                                    :subItemSelected="[
                                        ['title' => 'Surat Tugas', 'subLink' => route('administrasi.surat-tugas')],
                                        ['title' => 'SPJ', 'subLink' => '#'],
                                    ]">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="size-6">
                            ...
                            @endguest
                            <x-dashboard.sidebar-item itemSelected="Tentang" href="{{ route('about') }}"><svg
