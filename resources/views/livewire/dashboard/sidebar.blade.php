                ...
                <ul class="mb-6 flex flex-col gap-4">
                    ...
                    <div>
                        ...
                        <ul class="mb-6 flex flex-col gap-4">
                            ...
                            @endguest
                             <x-dashboard.sidebar-item itemSelected="Tentang" href="{{ route('about') }}" ><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
