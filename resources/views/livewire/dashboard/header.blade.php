                ...
                <div class="relative" x-data="{ dropdownOpen: false, notifying: true }" @click.outside="dropdownOpen = false">
                    ...
                    <div x-show="dropdownOpen"
                        ...
                        <ul class="custom-scrollbar flex h-auto flex-col overflow-y-auto">
                            ...
                            <li>
                                <span class="text-slate-700 text-sm">Sedang dalam pengembangan</span>
                            </li>
                        </ul>
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                    ...
                    <span class="text-theme-sm mr-1 block font-medium">
                        {{ Auth::user() ? Auth::user()->nama : 'Tamu' }} </span>
                ...
                <div x-show="dropdownOpen"
                    ...
                    @if (Auth::user())
                        <a wire:click.prevent="logout"
                            class="group relative text-sm mt-3 flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300 cursor-pointer">
                            ...
                            <div 
                                wire:loading wire:target='logout'
                                class="h-4 w-4 animate-spin rounded-full border-2 border-solid border-slate-700 border-t-transparent">
                            </div>
                        </a>
                    @else
                        <a href="{{ route('login') }}" wire:navigate
                            ...
                            <span class="ml-1 font-medium text-theme-sm text-gray-700">
                                Login
                            </span>
                        </a>
                    @endif
