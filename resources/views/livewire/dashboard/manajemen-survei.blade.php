                                    ...
                                    @foreach ([['label' => 'Nama Kegiatan', 'model' => 'kegiatan', 'type' => 'text'], ['label' => 'Alias', 'model' => 'alias', 'type' => 'text'], ['label' => 'Subsektor', 'model' => 'subsektor', 'type' => 'number']] as $field)
                                        <div class="flex flex-col">
                                            ...
                                            <input type="{{ $field['type'] }}" wire:model="{{ $field['model'] }}"
                                                id="{{ $field['model'] }}" name="{{ $field['model'] }}"
    ...
    <tbody class="bg-white dark:bg-gray-800">
        @foreach ($kegiatanSurvei as $e)
            <tr>
                ...
                <td class="px-6 whitespace-no-wrap border-b  text-gray-700 border-gray-200 dark:border-gray-600">
                    {{ $e->alias }}
                </td>
                <td class="px-6 whitespace-no-wrap border-b  text-gray-700 border-gray-200 dark:border-gray-600">
...
@if ($showDetail && $selectedKegiatan)
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm"
        wire:click="$set('showDetail', false)" x-transition:enter="ease-out duration-300"
