<div 
    ...
    <div
        ...
        <!-- Atau -->
        <div class="relative py-3 sm:py-2">
            <div class="absolute inset-0 flex items-center">
                <div class="w-full border-t border-gray-200 dark:border-gray-800"></div>
            </div>
            <div class="relative flex justify-center text-sm">
                <span class="px-4 text-gray-400 bg-white dark:bg-gray-900">Or</span>
            </div>
        </div>
        ...
        <form wire:submit.prevent="login" class="space-y-5">
            ...
            <div class="relative">
                <button type="submit"
                    class="w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-brand-500 hover:bg-brand-600 shadow-sm">
                    <span wire:loading.class='text-brand-500' wire:target='login'>
                        Login
                    </span>
                </button>
