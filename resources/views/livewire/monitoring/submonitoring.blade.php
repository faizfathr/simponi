<div x-data="{ idMonitoring: @entangle('idMonitoring') }" x-watch="idMonitoring"
    x-effect="
        if (idMonitoring) {
            ...
            fetch('/dashboard/data', {
                ...
                body: JSON.stringify({ tahun: 2026, subsektor: subsektorActived })
            })
            ...
            .then(responses => {
                responses.map((response) => {
                    const persen = parseFloat(response.realisasi / response.target * 100);
                    halfDonutChart(response.id, Number(persen.toFixed(2)));
                })
            })
            .catch(error => console.error('Fetch error:', error));
        }
                ...
                <div class="  rounded-2xl border border-gray-200 bg-gray-200 dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="shadow-default rounded-2xl bg-white px-5 pb-11 pt-5 dark:bg-gray-900 sm:px-6 sm:pt-6">
                        ...
                        <div class="text-center">
                            ...
                            <div
                                class="flex items-center justify-center gap-5 px-6 py-3.5 sm:gap-8 sm:py-5 bg-gray-200 dark:bg-gray-800 rounded-lg mt-6">
                                <div>
                                    <p
    ...
    <div class=" dark:bg-gray-900 h-screen">
        ...
        <div class="grid gap-2" wire:key="{{ $idMonitoring }}">
                ...
                <div x-data="{ openDropDown: false }"
                    ...
                    <div class="flex flex-col items-center text-center relative">
                        ...
                        <div x-show="openDropDown" x-transition @click.outside="openDropDown = false"
                            class="mt-2 w-40 p-2 space-y-1 bg-white border border-gray-200 rounded-2xl shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark max-h-40 overflow-y-auto self-end">
                            <button
