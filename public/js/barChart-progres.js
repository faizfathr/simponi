const barChart = (idElemen = '#', survei="", tahun=2025) => {

  const chartSelector = document.querySelector(idElemen);
...
barChart('#chartProgresKSA', 'Survei Kerangka Sampel Area (KSA)', 2025)
